...
ADE20K_150_CATEGORIES = [
    ...
    {"color": [253, 203, 110], "id": 14, "isthing": 1, "name": "door"},
    {"color": [41, 128, 185], "id": 15, "isthing": 1, "name": "table"},
    ...
    {"color": [255, 0, 0], "id": 24, "isthing": 1, "name": "shelf"},
    ...
    {"color": [255, 9, 152], "id": 28, "isthing": 0, "name": "rug"},
    ...
    {"color": [241, 196, 15], "id": 40, "isthing": 0, "name": "base, pedestal, stand"},
    ...
    {"color": [155, 89, 182], "id": 66, "isthing": 1, "name": "bouquet, flower"},
    ...
    {"color": [250, 177, 160], "id": 77, "isthing": 0, "name": "bar"},
    ...
    {"color": [162, 155, 254], "id": 81, "isthing": 1, "name": "towel"},
    ...
    {"color": [211, 84, 0], "id": 93, "isthing": 1, "name": "pole"},
    ...
    {"color": [25, 0, 251], "id": 108, "isthing": 1, "name": "plaything, toy"},
    ...
    #{"color": [61, 230, 250], "id": 150, "isthing": 0, "name": "screwdriver"},
    #{"color": [61, 100, 250], "id": 151, "isthing": 0, "name": "wrench"},
    #{"color": [102, 100, 150], "id": 152, "isthing": 0, "name": "drill, borer, power drill, electric drill, auger"},
    #{"color": [255, 214, 0], "id": 153, "isthing": 0, "name": "pliers"},
    #{"color": [184, 255, 0], "id": 154, "isthing": 0, "name": "chisel"},
    ##{"color": [92, 0, 255], "id": 155, "isthing": 0, "name": "blowtorch, burner, propane torch, heat gun"},
    #{"color": [255, 0, 92], "id": 156, "isthing": 0, "name": "scissors"},
    #{"color": [71, 0, 255], "id": 157, "isthing": 0, "name": "stapler"},
    #{"color": [0, 71, 155], "id": 158, "isthing": 0, "name": "cabbage"},

    #{"color": [61, 230, 250], "id": 150, "isthing": 0, "name": "musical instrument"},
    #{"color": [61, 100, 250], "id": 151, "isthing": 0, "name": "guitar, baroque guitar, ukulele"},
    #{"color": [102, 100, 150], "id": 152, "isthing": 0, "name": "harp"},
    #{"color": [255, 214, 0], "id": 153, "isthing": 0, "name": "lute"},
    #{"color": [184, 255, 0], "id": 154, "isthing": 0, "name": "violin, rebec"},
    #{"color": [92, 0, 255], "id": 155, "isthing": 0, "name": "flute, recorder"},
    #{"color": [255, 0, 92], "id": 156, "isthing": 0, "name": "trumpet, oboe"},
    #{"color": [71, 0, 255], "id": 157, "isthing": 0, "name": "serpent"},
]
...
ADE20K_847_CATEGORIES = [
    ...
    {"name": "tub, bathtub, bathing tub, bath", "id": 155, "trainId": 37},
    ...
    {
        "name": "tv, television receiver, television, television set, tv set, idiot box, boob tube, telly, goggle box",
        "id": 2733,
        "trainId": 88,
    },
    ...
    {"name": "clothes, apparel, wearing apparel, dress", "id": 38, "trainId": 102},
    ...
    {
        "name": "trash can, ashcan, garbage can, wastebin, ash bin, ash-bin, ashbin, dustbin, trash barrel, trash bin",
        "id": 64,
        "trainId": 127,
    },
...
def get_coco_categories_with_prompt_eng():
    ...
    coco_id_names = open('./ovrcoat/data/datasets/coco_panoptic_with_prompt_eng.txt').read().splitlines()
    coco_idx = 0
...
def get_coco_stuff_categories_with_prompt_eng():
    ...
    coco_id_names = open('./ovrcoat/data/datasets/coco_stuff_with_prompt_eng.txt').read().splitlines()
    coco_idx = 0
    for line in coco_id_names:
        idx, name = line.split(':')
        idx = int(idx)
...
def get_ade20k_categories_with_prompt_eng():
    ...
    ade20k_id_names = open('./ovrcoat/data/datasets/ade20k_150_with_prompt_eng.txt').read().splitlines()
    ade_idx = 0
...
def get_cityscapes_categories_with_prompt_eng():
    ...
    cityscapes_id_names = open('./ovrcoat/data/datasets/cityscapes_with_prompt_eng.txt').read().splitlines()
    cityscapes_idx = 0
...
def get_ade20k_847_categories_with_prompt_eng():
    ...
    ade20k_847_id_names = open('./ovrcoat/data/datasets/ade20k_847_with_prompt_eng.txt').read().splitlines()
    ade_idx = 0
...
def get_pascal_21_categories_with_prompt_eng():
    ...
    pascal_21_id_names = open('./ovrcoat/data/datasets/pascal_voc_21_with_prompt_eng.txt').read().splitlines()
    pas_idx = 0
...
def get_pascal_ctx_459_categories_with_prompt_eng():
    ...
    pascal_ctx_459_id_names = open('./ovrcoat/data/datasets/pascal_ctx_459_with_prompt_eng.txt').read().splitlines()
    pas_idx = 0
...
def get_pascal_ctx_59_categories_with_prompt_eng():
    ...
    pascal_ctx_59_id_names = open('./ovrcoat/data/datasets/pascal_ctx_59_with_prompt_eng.txt').read().splitlines()
    pas_idx = 0
...
def get_mapillary_vistas_categories_with_prompt_eng():
    ...
    mapillary_vistas_id_names = open('./ovrcoat/data/datasets/mapillary_vistas_with_prompt_eng.txt').read().splitlines()
    mapillary_idx = 0
